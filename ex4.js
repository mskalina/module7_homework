...
iron1.plug()
console.log(iron1)
//Сейчас получается, что аргумент свойство power объявлено и в родительской функции, и в подчиненных. Можно ли этого избежать? чтобы свойство лежало в главной функции, и принимало аргумент из подчиненной?
